<section id="faq" class="faq">
    <div class="wrapper">
        <h1 class="faq__title">FAQ - pytania i odpowiedzi dotyczące zarządzania najmem</h1>
        <div class="faq__box">
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Na jak długi okres czasu przewidujesz wynajem mieszkania?</h4>
            ...
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Kto będzie mieszkać w moim mieszkaniu?</h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
            ...
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Jaką mam pewność, że będę miał regularne płatności?</h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
                    <p>Dokładnie dobieram podnajemców i stosuję elektroniczne płatności dla ułatwienia transakcji.
                        Przypominam o terminach płatności i w umowie podkreślam konsekwencje opóźnień, co pomaga
                        utrzymać płynność finansową.</p>
                </div>
            </div>
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Jak postępujesz w przypadku wystąpienia uszkodzeń w mieszkaniu spowodowanych przez podnajemców?
                    </h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
            ...
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Czy zgodzisz się na umieszczenie klauzuli dotyczącej regularnych inspekcji stanu mieszkania?
                    </h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
            ...
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Jaki jest twój plan działania na wypadek pustostanów?
                    </h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
                    <p>Mój plan działania na wypadek pustostanów obejmuje aktywne promowanie nieruchomości i
                        utrzymywanie solidnej bazy potencjalnych najemców. Dzięki współpracy z korporacjami i innymi
                        instytucjami, jestem w stanie szybko reagować i znaleźć odpowiednich podnajemców. Dodatkowo,
                        zawsze posiadam bufor finansowy, który umożliwia mi pokrywanie ewentualnych kosztów związanych z
                        tymczasowym brakiem dochodu z wynajmu.</p>
                </div>
            </div>
            <div class="faq__box--item">
                <div class="faq__box--header">
            ...
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Co mi da współpraca z Panem?
                    </h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
            ...
            <div class="faq__box--item">
                <div class="faq__box--header">
                    <h4>Czy przewidujesz korektę czynszu w razie wzrostu cen na rynku?
                    </h4>
                    <span class="faq__box--indicator"><i class="fa-solid fa-plus"></i></span>
                </div>
                <div class="faq__box--content">
            ...
            <!-- Możesz dodać więcej elementów harmonijki kopiując strukturę faq__box--item -->
        </div>
    </div>
</section>
