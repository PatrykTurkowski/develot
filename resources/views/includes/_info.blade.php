<section class="info">
    <div class="white-shadow">
        <div class="info__text wrapper">
            <h1>Ciągle masz wątpliwości?</h1>
            <p>Masz mieszkanie do wynajęcia, ale obawy ciągną Cię w dół? Zapomnij o nich! Oferujemy rozwiązanie, które
                całkowicie odmieni Twoje myślenie o wynajmie nieruchomości.</p>
